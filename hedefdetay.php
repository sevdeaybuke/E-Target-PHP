...
$urunsor=$db->prepare("SELECT hedef.*,kullanici.* FROM hedef INNER JOIN kullanici ON hedef.kullanici_id=kullanici.kullanici_id where hedef_id=:id and hedef_durum=:durum");
...
<div class="inner-banner-area">
    <div class="container">
        <div class="inner-banner-wrapper">
            <h2 style="color:white;"><?php echo $uruncek['hedef_ad'] ?></h2>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <ul class="product-details-title">
                                    <li class="active"><a href="#description" data-toggle="tab" aria-expanded="false">Hedef Açıklaması</a></li>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="tab-content">
                                    <div class="tab-pane fade active in" id="description">
                                       <p><?php echo $uruncek['hedef_detay'] ?></p>
                                   </div>
                                   <div class="tab-pane fade" id="review">
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-md-8">
                                                ...
                                                <div class="comments-list">
                                                    ...
                                                    <?php 
                                                    $yorumsor=$db->prepare("SELECT yorumhedef.*,kullanici.* FROM yorumhedef INNER JOIN kullanici ON yorumhedef.kullanici_id=kullanici.kullanici_id where hedef=:id order by yorumhedef_zaman DESC");
                                                    ...
                                                    if (!$yorumsor->rowCount()) {
                                                       ...
                                                       echo "Bu hedef için henüz yorum girilmemiştir";
                                                   }
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <h4 class="media-heading user_name"><img style="border-radius: 30px; float: left; margin-right: 10px;" width="32" height="32" class="img-responsive" src="<?php echo $yorumcek['kullanici_magazafoto'] ?>" alt="Profil Resmi"> <?php echo $yorumcek['kullanici_ad']." ".$yorumcek['kullanici_soyad'] ?> 
                                                            ...
                                                            <ul style="float:right" class="default-rating">
                                                                ...
                                                                switch ($yorumcek['yorumhedef_puan']) {
                                                                ...
                                                                <li>(<span> <?php echo $yorumcek['yorumhedef_puan'] ?></span> )</li>
                                                            </ul>
                                                        </h4>
                                                        <?php echo $yorumcek['yorumhedef_detay'] ?>
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                            <div class="fox-sidebar">
                                                <div class="sidebar-item">
                                                    <div class="sidebar-item-inner">
                                                        <h3 class="sidebar-item-title">Hedef Coini</h3>
                                                        <div align="center">
                                                            <b style="font-size:30px;"><?php echo $uruncek['hedef_fiyat'] ?><span style="font-size:12px;"> coin</span></b>
                                                            <hr>
                                                        ...
                                                        <form action="odeme" method="POST">
                                                          <ul class="sidebar-product-btn">
                                                            ...
                                                            <input type="hidden" name="urun_id" value="<?php echo $uruncek['hedef_id'] ?>">
                                                            ...
                                                            <li><a class="add-to-cart-btn" id="cart-button"><i class="fa fa-ban" aria-hidden="true"></i> Kendi Hedefiniz</a></li>

                                                            <?php  } else {?>

                                                            <li><button type="submit" class="add-to-cart-btn" id="cart-button"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Coin Sat</button></li>
                                            ...
                                            <div class="sidebar-item">
                                                <div class="sidebar-item-inner">
                                                    <h3 class="sidebar-item-title">Hedef Sahibi</h3>
                                                    <div class="sidebar-author-info">
                                                        ...
                                                        <div class="sidebar-author-content">
                                                            ...
                                                            <a href="hedefci-<?=seo($uruncek['kullanici_ad']."-".$uruncek['kullanici_soyad'])."-".$uruncek['kullanici_id'] ?>" class="view-profile">Profil Sayfası</a>
                                                        </div>
                                                    </div>
                                                    <ul class="sidebar-badges-item">
                                                        <?php 

                                                        $urunsay=$db->prepare("SELECT COUNT(kullanici_idsatici) as say FROM hedef_detay where kullanici_idsatici=:id");
                                                        $urunsay->execute(array(
