...
$urunsor=$db->prepare("SELECT * FROM basarisozleri order by id DESC");
$urunsor->execute();
  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Başarı Sözleri Listeleme <small>,
            ...
            <div align="right">
              <a href="basarisozleri-ekle.php"><button class="btn btn-success btn-xs"> Yeni Ekle</button></a>
