          ...
          <div class="x_content">
            ...
            <div class="form-group">
              <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                ...
                <a onclick="return confirm('Hedef başvurusunu iptal etmek istiyormusunuz?')" class="btn btn-danger" href="../netting/adminislem.php?hedef-onay=red&kullanici_id=<?php echo $kullanicicek['kullanici_id']; ?>">Başvuruyu İptal Et</a>
