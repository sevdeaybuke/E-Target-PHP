...
//Mağaza Hedef Ekleme İşlemleri

if (isset($_POST['magazahedefekle'])) {
...
//Fotoğraf Yoksa İşlemler
		...
		if ($update) {
			...
			Header("Location:../../hedefduzenle.php?durum=ok&urun_id=$urun_id");

		} else {

			Header("Location:../../hedefduzenle.php?durum=hata&urun_id=$urun_id");
		}
