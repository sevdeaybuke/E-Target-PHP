...
$urunsor=$db->prepare("SELECT * FROM hedef where kullanici_id=:kullanici_id and hedef_id=:hedef_id order by hedef_zaman DESC");
      ...
      <form action="nedmin/netting/adminislem.php" method="POST" enctype="multipart/form-data" class="form-horizontal" id="personal-info-form">
        ...
        <div class="settings-details tab-content">
          <div class="tab-pane fade active in" id="Personal">
            <h2 class="title-section">Hedef Düzenle</h2>
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input class="form-control" required="" name="hedef_ad" id="first-name" value="<?php echo $uruncek['hedef_ad'] ?>" type="text">
                </div>
              </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input class="form-control" required="" name="hedef_fiyat" id="first-name" value="<?php echo $uruncek['hedef_fiyat'] ?>" type="text">
              </div>
            </div>

            <input type="hidden" value="<?php echo $uruncek['hedef_id'] ?>" name="hedef_id">
