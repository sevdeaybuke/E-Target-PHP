            ...
            ?>
              ...
              <div class="settings-details tab-content">
                  <div class="tab-pane fade active in" id="Personal">
                      <h2 class="title-section">Hedef Başvurusu</h2>
                    ...
                    <div class="form-group">
                        ...
                        <div align="right" class="col-sm-12">
                           <button class="update-btn" name="kullanicihedefbasvuru" id="login-update">Başvuruyu Tamamla</button>
                    ...
                    <?php } else if ($kullanicicek['kullanici_magaza']==2) {?> 
                       ...
                       <div class="alert alert-success">
                        <strong>Bilgi!</strong> Hedefiniz Onaylandı.

                        <p>Hedef yönetim menüsünden mağazanızı yönetebilirsiniz.</p>
                    </div> 
